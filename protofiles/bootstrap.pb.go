...
const file_bootstrap_proto_rawDesc = "" +
	"\n" +
	"\x0fbootstrap.proto\x12\x03can\x1a\x1bgoogle/protobuf/empty.proto\"+\n" +
	...
	"\x16BootstrapLeaveResponse\"3\n" +
	"\x11RootCApemResponse\x12\x1e\n" +
	"\vroot_ca_pem\x18\x01 \x01(\fR\trootCaPem\"@\n" +
	"\x0eSignCSRRequest\x12\x17\n" +
	"\acsr_pem\x18\x01 \x01(\fR\x06csrPem\x12\x15\n" +
	"\x06ip_san\x18\x02 \x01(\tR\x05ipSan\"9\n" +
	"\x0fSignCSRResponse\x12&\n" +
	"\x0fsigned_cert_pem\x18\x01 \x01(\fR\rsignedCertPem2\x80\x02\n" +
	"\x10BootstrapService\x127\n" +
	"\bJoinInfo\x12\x14.can.JoinInfoRequest\x1a\x15.can.JoinInfoResponse\x12=\n" +
	"\x05Leave\x12\x17.can.BootstrapLeaveInfo\x1a\x1b.can.BootstrapLeaveResponse\x12>\n" +
	"\fGetRootCApem\x12\x16.google.protobuf.Empty\x1a\x16.can.RootCApemResponse\x124\n" +
	"\aSignCSR\x12\x13.can.SignCSRRequest\x1a\x14.can.SignCSRResponseB\x0eZ\f./protofilesb\x06proto3"
