...
type TakeoverRequest struct {
	...
	LeavingNeighbors   []*Node                `protobuf:"bytes,4,rep,name=leaving_neighbors,json=leavingNeighbors,proto3" json:"leaving_neighbors,omitempty"` // List of neighboring nodes
	IsGraceful         bool                   `protobuf:"varint,5,opt,name=is_graceful,json=isGraceful,proto3" json:"is_graceful,omitempty"`                  // Whether this is a graceful leave or a crash
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *TakeoverRequest) GetLeavingNeighbors() []*Node {
	if x != nil {
		return x.LeavingNeighbors
	}
	return nil
}
...
type ZoneMergeNotification struct {
	...
	TakeoverAddress string                 `protobuf:"bytes,2,opt,name=takeover_address,json=takeoverAddress,proto3" json:"takeover_address,omitempty"`
	OldZone         *Zone                  `protobuf:"bytes,3,opt,name=old_zone,json=oldZone,proto3" json:"old_zone,omitempty"`
	NewZone         *Zone                  `protobuf:"bytes,4,opt,name=new_zone,json=newZone,proto3" json:"new_zone,omitempty"`
	LeavingNodeId   string                 `protobuf:"bytes,5,opt,name=leaving_node_id,json=leavingNodeId,proto3" json:"leaving_node_id,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ZoneMergeNotification) GetTakeoverAddress() string {
	if x != nil {
		return x.TakeoverAddress
	}
	return ""
...
type UpdateSiblingRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Sibling       *Node                  `protobuf:"bytes,1,opt,name=sibling,proto3" json:"sibling,omitempty"`                                    // The sibling node to merge
	LeavingNodeId string                 `protobuf:"bytes,2,opt,name=leaving_node_id,json=leavingNodeId,proto3" json:"leaving_node_id,omitempty"` // The node that is leaving
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdateSiblingRequest) Reset() {
	*x = UpdateSiblingRequest{}
	mi := &file_can_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateSiblingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateSiblingRequest) ProtoMessage() {}

func (x *UpdateSiblingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_can_proto_msgTypes[31]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateSiblingRequest.ProtoReflect.Descriptor instead.
func (*UpdateSiblingRequest) Descriptor() ([]byte, []int) {
	return file_can_proto_rawDescGZIP(), []int{31}
}

func (x *UpdateSiblingRequest) GetSibling() *Node {
	if x != nil {
		return x.Sibling
	}
	return nil
...
func (x *UpdateSiblingRequest) GetLeavingNodeId() string {
	if x != nil {
		return x.LeavingNodeId
	}
	return ""
...
type UpdateSiblingResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	ErrorMessage  string                 `protobuf:"bytes,2,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *UpdateSiblingResponse) Reset() {
	*x = UpdateSiblingResponse{}
	mi := &file_can_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateSiblingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateSiblingResponse) ProtoMessage() {}

func (x *UpdateSiblingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_can_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateSiblingResponse.ProtoReflect.Descriptor instead.
func (*UpdateSiblingResponse) Descriptor() ([]byte, []int) {
	return file_can_proto_rawDescGZIP(), []int{32}
}

func (x *UpdateSiblingResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *UpdateSiblingResponse) GetErrorMessage() string {
	if x != nil {
		return x.ErrorMessage
	}
	return ""
...
var file_can_proto_rawDesc = string([]byte{
	...
	0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x41, 0x0a, 0x0d, 0x44, 0x65,
	...
	,
	...
	0x72, 0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x86, 0x01, 0x0a, 0x0a, 0x44,
	0x46, 0x53, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x0f, 0x6c, 0x65, 0x61,
	0x76, 0x69, 0x6e, 0x67, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0d, 0x6c, 0x65, 0x61, 0x76, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65, 0x49,
	0x64, 0x12, 0x2a, 0x0a, 0x0b, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x7a, 0x6f, 0x6e, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x63, 0x61, 0x6e, 0x2e, 0x5a, 0x6f, 0x6e,
	0x65, 0x52, 0x0a, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5a, 0x6f, 0x6e, 0x65, 0x12, 0x24, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_can_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_can_proto_goTypes = []any{
	...
	(*UpdateSiblingRequest)(nil),        // 31: can.UpdateSiblingRequest
	(*UpdateSiblingResponse)(nil),       // 32: can.UpdateSiblingResponse
}
var file_can_proto_depIdxs = []int32{
	...
	1,  // 12: can.TakeoverRequest.leaving_neighbors:type_name -> can.Node
	2,  // 13: can.TransferDataResponse.data:type_name -> can.KeyValuePair
	1,  // 14: can.GetNeighborsResponse.neighbors:type_name -> can.Node
	0,  // 15: can.ZoneMergeNotification.old_zone:type_name -> can.Zone
	0,  // 16: can.ZoneMergeNotification.new_zone:type_name -> can.Zone
	1,  // 17: can.UpdateSiblingRequest.sibling:type_name -> can.Node
	3,  // 18: can.CANNode.Join:input_type -> can.JoinRequest
	5,  // 19: can.CANNode.Get:input_type -> can.GetRequest
	7,  // 20: can.CANNode.Put:input_type -> can.PutRequest
	9,  // 21: can.CANNode.Delete:input_type -> can.DeleteRequest
	11, // 22: can.CANNode.AddNeighbor:input_type -> can.AddNeighborRequest
	13, // 23: can.CANNode.Heartbeat:input_type -> can.HeartbeatRequest
	15, // 24: can.CANNode.SendNeighbourInfo:input_type -> can.NeighbourInfoRequest
	17, // 25: can.CANNode.InitiateLeave:input_type -> can.LeaveRequest
	19, // 26: can.CANNode.PerformDFS:input_type -> can.DFSRequest
	21, // 27: can.CANNode.TakeoverZone:input_type -> can.TakeoverRequest
	23, // 28: can.CANNode.TransferData:input_type -> can.TransferDataRequest
	25, // 29: can.CANNode.GetNeighbors:input_type -> can.GetNeighborsRequest
	27, // 30: can.CANNode.NotifyZoneMerge:input_type -> can.ZoneMergeNotification
	29, // 31: can.CANNode.ElectTakeoverCoordinator:input_type -> can.CoordinatorElectionRequest
	31, // 32: can.CANNode.UpdateSibling:input_type -> can.UpdateSiblingRequest
	4,  // 33: can.CANNode.Join:output_type -> can.JoinResponse
	6,  // 34: can.CANNode.Get:output_type -> can.GetResponse
	8,  // 35: can.CANNode.Put:output_type -> can.PutResponse
	10, // 36: can.CANNode.Delete:output_type -> can.DeleteResponse
	12, // 37: can.CANNode.AddNeighbor:output_type -> can.AddNeighborResponse
	14, // 38: can.CANNode.Heartbeat:output_type -> can.HeartbeatResponse
	16, // 39: can.CANNode.SendNeighbourInfo:output_type -> can.NeighbourInfoResponse
	18, // 40: can.CANNode.InitiateLeave:output_type -> can.LeaveResponse
	20, // 41: can.CANNode.PerformDFS:output_type -> can.DFSResponse
	22, // 42: can.CANNode.TakeoverZone:output_type -> can.TakeoverResponse
	24, // 43: can.CANNode.TransferData:output_type -> can.TransferDataResponse
	26, // 44: can.CANNode.GetNeighbors:output_type -> can.GetNeighborsResponse
	28, // 45: can.CANNode.NotifyZoneMerge:output_type -> can.ZoneMergeResponse
	30, // 46: can.CANNode.ElectTakeoverCoordinator:output_type -> can.CoordinatorElectionResponse
	32, // 47: can.CANNode.UpdateSibling:output_type -> can.UpdateSiblingResponse
